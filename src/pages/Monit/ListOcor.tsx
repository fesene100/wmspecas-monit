...
export const ListOcor: React.FC = () => {
  ...
  const [columnDefs] = useState<ColDef[]>([
    ...
    { field: "difEstoque", width: 100, sortable: true, filter: "text", headerName: "Estoque", resizable: true },
    { field: "pecaDesc", sortable: true, filter: "text", headerName: "Descrição", resizable: true },
    {
      field: "produtoDesc",
      sortable: true,
      filter: "number",
